...
class TicTacToe(playerOne: BestMoveFinder[TicTacToeState], 
  ...
  def play = {
    var moveNumber = 0
    if (bandera == 0) {
        if (computerOrP2 == "player_2") {
            name_p1 = readLine("\033[32mchoose player_1 name ")
            name_p2 = readLine("\033[32mchoose player_2 name ")
            println("\033[0m")
        } else if(computerOrP2 == "machine") {
            name_p1 = readLine("\033[32mchoose player_1 name ")
            println("\033[0m")
        } else {
    ...
    if(game.playerOneWin) {
        score1 += 2
        println("\033[31m----------------------!")
        println(s"\033[35m$name_p1 win!")
        println(s"Score: $name_p1 = $score1")
        println(s"Score: $name_p2 = $score2")
        println("\033[31m----------------------!\n")           
    }
    else if(game.playerTwoWin) {
        score2 += 2
        println("\033[31m----------------------!") 
        println(s"\033[35m$name_p2 Two win!")
        println(s"Score: $name_p2 = $score2")
        println(s"Score: $name_p1 = $score1")
        println("\033[31m----------------------!\n") 
    }
...
println(s"\033[35mScore $name_p1: = " + score1)
println(s"\033[35mScore $name_p2: = " + score2)
println("\033[31m----------------------!\n") 
